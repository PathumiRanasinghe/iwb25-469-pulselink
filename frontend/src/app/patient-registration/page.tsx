      ...
      <div className="relative z-10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Organ Requesting Patient Details Form</p>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <section className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Medical Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <section className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Organ Request Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Requested Organ
                  ...
                  <div className="relative group">
                    ...
                    >
                      <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Organ</option>
                      <option value="kidney" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Kidney</option>
                      <option value="liver" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Liver</option>
                      <option value="heart" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Heart</option>
                      <option value="lung" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Lung</option>
                      <option value="pancreas" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Pancreas</option>
                      <option value="cornea" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Cornea</option>
                      <option value="bone" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Bone</option>
                      <option value="skin" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Skin</option>
                    </select>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                      <svg className="w-5 h-5 text-gray-400 transition-transform duration-200 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      >
                        <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Blood Type</option>
                        <option value="A+" style={{backgroundColor: '#374151', color: '#d1d5db'}}>A+</option>
                        <option value="A-" style={{backgroundColor: '#374151', color: '#d1d5db'}}>A-</option>
                        <option value="B+" style={{backgroundColor: '#374151', color: '#d1d5db'}}>B+</option>
                        <option value="B-" style={{backgroundColor: '#374151', color: '#d1d5db'}}>B-</option>
                        <option value="AB+" style={{backgroundColor: '#374151', color: '#d1d5db'}}>AB+</option>
                        <option value="AB-" style={{backgroundColor: '#374151', color: '#d1d5db'}}>AB-</option>
                        <option value="O+" style={{backgroundColor: '#374151', color: '#d1d5db'}}>O+</option>
                        <option value="O-" style={{backgroundColor: '#374151', color: '#d1d5db'}}>O-</option>
                      </select>
                      <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg className="w-5 h-5 text-gray-400 transition-transform duration-200 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      >
                        <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Critically life-limiting</option>
                        <option value="high" style={{backgroundColor: '#374151', color: '#d1d5db'}}>High</option>
                        <option value="moderate" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Moderate</option>
                        <option value="low" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Low</option>
                      </select>
                      <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg className="w-5 h-5 text-gray-400 transition-transform duration-200 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"/>
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      >
                        <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Urgency</option>
                        <option value="critical" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Critical</option>
                        <option value="urgent" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Urgent</option>
                        <option value="routine" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Routine</option>
                      </select>
                      <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg className="w-5 h-5 text-gray-400 transition-transform duration-200 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"/>
                    ...
                    <div className="relative">
                      ...
                      >
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          ...
                          <p className="text-xs text-gray-500">TXT, DOC, DOCX or PDF (MAX. 10MB)</p>
                        </div>
                      </label>
                        ...
                        <div className="mt-3 p-3 bg-gray-700/50 rounded-lg border border-gray-600">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-gray-300">{formData.crossMatchReport.name}</span>
                            </div>
                            <button
                              type="button"
                              onClick={() => setFormData(prev => ({ ...prev, crossMatchReport: null }))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      >
                        <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Identification Type</option>
                        <option value="national_id" style={{backgroundColor: '#374151', color: '#d1d5db'}}>National ID</option>
                        <option value="passport" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Passport</option>
                        <option value="drivers_license" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Driver's License</option>
                        <option value="birth_certificate" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Birth Certificate</option>
                      </select>
                      <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
              ...
              <div className="text-center pt-4">
                <Link href="/" className="text-sky-300 hover:text-sky-300 transition-colors">
                  ← Back to Home
                </Link>
              </div>
            </form>
