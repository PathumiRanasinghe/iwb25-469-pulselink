            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Organ Donor (Deceased) Intake Form</p>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <section className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Donor Identification</h3>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <label className="relative flex items-center p-4 bg-gradient-to-r from-gray-700/40 to-gray-600/40 border border-gray-500/50 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-gray-600/50 hover:to-gray-500/50 hover:border-gray-400/60 hover:shadow-lg hover:shadow-green-400/5 transition-all duration-300 ease-in-out transform hover:scale-[1.02] backdrop-blur-sm">
                      ...
                      />
                      <span className="ml-3 text-gray-300 font-medium">Male</span>
                    ...
                    <label className="relative flex items-center p-4 bg-gradient-to-r from-gray-700/40 to-gray-600/40 border border-gray-500/50 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-gray-600/50 hover:to-gray-500/50 hover:border-gray-400/60 hover:shadow-lg hover:shadow-green-400/5 transition-all duration-300 ease-in-out transform hover:scale-[1.02] backdrop-blur-sm">
                      <input
                        ...
                        className="h-5 w-5 text-green-400 focus:ring-green-400/50 focus:ring-2 border-gray-500 bg-gray-700/60 transition-all duration-200"
                      />
                      <span className="ml-3 text-gray-300 font-medium">Female</span>
                    ...
                    <label className="relative flex items-center p-4 bg-gradient-to-r from-gray-700/40 to-gray-600/40 border border-gray-500/50 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-gray-600/50 hover:to-gray-500/50 hover:border-gray-400/60 hover:shadow-lg hover:shadow-green-400/5 transition-all duration-300 ease-in-out transform hover:scale-[1.02] backdrop-blur-sm">
                      <input
                        ...
                        className="h-5 w-5 text-green-400 focus:ring-green-400/50 focus:ring-2 border-gray-500 bg-gray-700/60 transition-all duration-200"
                      />
                      <span className="ml-3 text-gray-300 font-medium">Other</span>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <label className="relative flex items-center p-3 bg-gradient-to-r from-gray-700/40 to-gray-600/40 border border-gray-500/50 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-gray-600/50 hover:to-gray-500/50 transition-all duration-300 backdrop-blur-sm">
                      ...
                      />
                      <span className="ml-3 text-gray-300 font-medium">Yes</span>
                    </label>
                    <label className="relative flex items-center p-3 bg-gradient-to-r from-gray-700/40 to-gray-600/40 border border-gray-500/50 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-gray-600/50 hover:to-gray-500/50 transition-all duration-300 backdrop-blur-sm">
                      <input
                        type="radio"
            ...
            <section className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Medical Suitability</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    >
                      <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Blood Group</option>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="availableOrgansForRetrieval"
                    value={formData.availableOrgansForRetrieval}
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-gradient-to-r from-gray-700/60 to-gray-600/60 border border-gray-500/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400/70 focus:border-green-400/50 hover:bg-gradient-to-r hover:from-gray-600/70 hover:to-gray-500/70 transition-all duration-300 backdrop-blur-sm"
                    placeholder="ex: Kidneys, Liver, Heart, Cornea"
                  />
                </div>
              </div>
            </section>
            ...
            <section className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Consent Source</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-gradient-to-r from-gray-700/60 to-gray-600/60 border border-gray-500/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-green-400/70 focus:border-green-400/50 hover:bg-gradient-to-r hover:from-gray-600/70 hover:to-gray-500/70 hover:border-gray-400/60 hover:shadow-lg hover:shadow-green-400/10 transition-all duration-300 ease-in-out transform hover:scale-[1.02] focus:scale-[1.02] appearance-none cursor-pointer backdrop-blur-sm"
                    >
                      <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Consent Type</option>
                      <option value="prior" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Prior Consent</option>
                      <option value="family" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Family Consent</option>
                      <option value="medical" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Medical Decision</option>
                    </select>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                      <svg className="w-5 h-5 text-gray-400 transition-transform duration-200 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"/>
                ...
                <div>
                  ...
                  <div className="relative group">
                    <select
                      ...
                      className="w-full px-4 py-3 bg-gradient-to-r from-gray-700/60 to-gray-600/60 border border-gray-500/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-green-400/70 focus:border-green-400/50 hover:bg-gradient-to-r hover:from-gray-600/70 hover:to-gray-500/70 hover:border-gray-400/60 hover:shadow-lg hover:shadow-green-400/10 transition-all duration-300 ease-in-out transform hover:scale-[1.02] focus:scale-[1.02] appearance-none cursor-pointer backdrop-blur-sm"
                    >
                      <option value="" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Select Relationship</option>
                      <option value="parent" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Parent</option>
                      <option value="spouse" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Spouse</option>
                      <option value="sibling" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Sibling</option>
                      <option value="child" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Child</option>
                      <option value="other" style={{backgroundColor: '#374151', color: '#d1d5db'}}>Other</option>
                    </select>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                      <svg className="w-5 h-5 text-gray-400 transition-transform duration-200 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"/>
                    ...
                    >
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="mb-2 text-sm text-gray-400">
                          <span className="font-semibold">Image or scanned PDF</span>
                        </p>
                      </div>
                    </label>
                    {formData.signature && (
                      <div className="mt-3 p-3 bg-gray-700/50 rounded-lg border border-gray-600">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-300">{formData.signature.name}</span>
                          </div>
                          <button
                            type="button"
            ...
            <section className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h3 className="text-2xl font-bold text-white mb-6">Hospital & Action</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
